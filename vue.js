const App = {
  ...
  computed: {
    activeStep(){ return this.steps[this.activeIndex] },
    isLastStep(){ return this.activeIndex === this.steps.length - 1 },
    isDisabled(){ return this.activeIndex === 0 },
    btnNextText(){ return this.isLastStep? 'Закончить': 'Далее' }
  }
}
